...
export default class cusPack extends Component {
  ...
  filterContent(packages, searchTerm) {
    const results = packages.filter((packages) =>
      packages.destination.toLowerCase().includes(searchTerm)
    );
      ...
      <div>
        <div className="container">
          ...
          <a
            className="customize"
            href="/edit/cusPack"
            class={myStyle.btnSubmit2}
            style={{ position: "absolute", right: 150, top: 410 }}
          >
            <strong>
          ...
          <div className="row">
            <div className="col-lg-9 mt-2 mb-2">
              <h3 className="Ball" class={myStyle.tableH}>
          ...
          <a href="/view/cuspackage" class={myStyle.btnBack}>
            <strong>Back</strong>
          </a>
          &nbsp;&nbsp;
        </div>
