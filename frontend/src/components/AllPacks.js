...
export default class AllPacks extends Component {
  ...
  filterContent(packages, searchTerm) {
    const results = packages.filter((packages) =>
      packages.packId.toLowerCase().includes(searchTerm)
    );
      ...
      <div className="container">
        ...
        <div class={myStyle.header3}>
          ...
          <div>
            ...
            <h1>
              <strong>
                <center>Manage package details</center>
              </strong>
            </h1>
            <br></br>
          </div>
        ...
        <h4
          style={{ position: "absolute", right: 1100, top: 120 }}
          class={myStyle.PackDetails}
        >
          Enter Pack_ID here
        </h4>
            ...
            {this.state.packages.map((packages, index) => (
              <tr class={myStyle.rows4}>
                ...
                <td>
                  <div>
                    <a
                      class={myStyle.btnUpdate}
                      href={`/update/${packages._id}`}
                      style={{ width: "200px" }}
                    >
                      Update
                    </a>{" "}
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a
                    class={myStyle.btnDelete}
                    onClick={() => this.onDelete(packages._id)}
                    style={{ width: "200px" }}
                  >
                    {" "}
                    Delete{" "}
        ...
        <div
          class="card-body"
          style={{ position: "absolute", right: 20, top: 900 }}
        >
          <h5 class="text-dark">
            <center>
