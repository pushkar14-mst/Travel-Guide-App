...
import coverImg from "../img/Beach.webp"
...
const Home = () => {
        ...
        <div className={styleHome.container}>
            ...
            <div className={styleHome.layer}>
                <div className={styleHome.centered}>
                    <div className={styleHome.headerTxt}>TRAVEL BEYOND IMAGINATION</div>
                    <div className={styleHome.sloganTxt}>Discover Your Journey, Explore Your World: Welcome to Explore Hub! <br/></div>
    ...
    <div class="gmap_canvas">
        <iframe 
            ...
            height="502" 
            id="gmap_canvas" 
            src="https://maps.google.com/maps?q=indiana&t=&z=7&ie=UTF8&iwloc=&output=embed" 
            frameborder="0" 
            scrolling="no" 
            marginheight="0" 
            marginwidth="0">
    ...
    <a href="https://www.embedgooglemap.net"></a>
        ...
        <div style={{padding: "100px 100px 20px 100px"}}>
            <p className={`text-center ${styleHome.destinationHeading}`}><span style={{color:"#d72929"}}>BEST</span> DESTINATIONS</p>
            <div className="row">
