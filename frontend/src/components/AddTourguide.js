...
function AddTourguide() {
  ...
  function sendData(e) {
    ...
    axios
      .post("http://127.0.0.1:8000/add-tourguide", newTourguide)
      .then(() => {
    ...
    >
      <form onSubmit={sendData}>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            <label for="age" class="form-label text-black">
              Age
            </label>
            <input
              type="text"
          ...
          <div class="form-group col-md-6">
            <label for="dateOfBirth" class="form-label text-black">
              Date Of Birth
            </label>
            <input
              type="date"
          ...
          <div class="form-group col-md-6">
            <label for="contactNumber" class="form-label text-black">
              Contact Number
            </label>
            <input
              type="number"
          ...
          <div class="form-group col-md-6">
            <label for="gender" class="form-label text-black">
              Gender
            </label>
            <select
              id="gender"
          ...
          <div class="form-group col-md-6">
            <label for="nicNumber" class="form-label text-black">
              NIC Number
            </label>
            <input
              type="text"
          ...
          <div class="form-group col-md-6">
            <label for="eMail" class="form-label text-black">
              E mail
            </label>
            <input
              type="email"
          ...
          <div class="form-group col-md-6">
            <label for="workExperience" class="form-label text-black">
              Work Experience
            </label>
            <input
              type="text"
              class="form-control"
              id="workExperience"
              placeholder="Enter Tourguide Work Expereince"
              onChange={(e) => {
          ...
          <div class="form-group col-md-6">
            <label for="amount" class="form-label text-black">
              Amount
            </label>
            <input
              type="text"
